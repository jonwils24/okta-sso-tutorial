...
//constants
const OKTA_ORG = 'https://oktaice8112.oktapreview.com';
const AUTHZ_SERVER = 'https://oktaice8112.oktapreview.com';
const AUTHZ_URL = AUTHZ_SERVER + '/oauth2/v1/authorize';
const CLIENT_ID = '0oaf4cac3szlxLobx0h7';
...
export function redirect() {
  ...
  .then(function (tokenArray) {
    ...
    //save the id_toek nand the access_token in the tokenManager
    OKTA_AUTH_JS.tokenManager.add('access_token', tokenArray[0]);
    OKTA_AUTH_JS.tokenManager.add('id_token', tokenArray[1]);
    router.push('/profile')
  })
